module.exports = {
  ...
  title: `Ivan Mao's Blog`,                           // (* Required)
  description: `Blog Description`,          // (* Required)
  author: `Ivan Mao`,                         // (* Required)
  language: 'cn',                        // (* Required) html lang, ex. 'en' | 'en-US' | 'ko' | 'ko-KR' | ...
  siteUrl: 'https://ivanmao714.github.io',                      // (* Required)
    // ex.'https://junhobaik.github.io'
    // ex.'https://junhobaik.github.io/' << X, Do not enter "/" at the end.

  /** Header */
  profileImageFileName: 'favicon.png', // include filename extension ex.'profile.jpg'
    // The Profile image file is located at path "./images/"
    // If the file does not exist, it is replaced by a random image.

  /** Home > Bio information*/
  comment: 'Hello! I\'m a student(sophomore year) in software engineering（B.S) from Macau University of Science and Technology.',
  name: 'Ivan Mao',
  company: '',
  location: 'China',
  email: 'maoyifan714@gmial.com',
  website: 'http://ivanmao.mo.cn',           // ex.'https://junhobaik.github.io'
  linkedin: '',                                                          // ex.'https://www.linkedin.com/in/junho-baik-16073a19ab'
  facebook: '',                                                          // ex.'https://www.facebook.com/zuck' or 'https://www.facebook.com/profile.php?id=000000000000000'
  instagram: '',                                                         // ex.'https://www.instagram.com/junhobaik'
  github: 'https://github.com/IvanMao714',                                                            // ex.'https://github.com/junhobaik'
